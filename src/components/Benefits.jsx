...
export default function Benefits() {
  ...
  return (
    <section id="benefits" className="section-shell bg-sage px-0 py-16 text-ink md:py-24 lg:py-32">
      ...
      <img src={kencur} alt="" className="halftone-cut absolute -left-10 top-36 hidden w-72 opacity-55 md:block md:w-[30rem]" />
      <img src={rice} alt="" className="drift absolute bottom-14 right-8 w-32 opacity-80 md:w-44" />

      <div className="section-inner relative z-10 grid items-stretch gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-10">
        <div className="reveal flex min-h-0 flex-col justify-between lg:min-h-[560px]">
          ...
          <div>
            ...
            <p className="body-copy mt-5 max-w-lg text-sm font-semibold text-forest sm:text-base md:mt-6 md:text-lg">
              Beras kencur dikenal sebagai minuman herbal yang membantu tubuh terasa lebih segar
              dan nyaman dalam aktivitas harian.
            </p>
          </div>

          <div className="mt-8 rounded-[1.4rem] border-2 border-ink bg-paper/80 p-4 shadow-soft backdrop-blur md:mt-10 md:rounded-[1.7rem] md:p-5">
        ...
        <div className="reveal relative overflow-hidden rounded-[1.6rem] bg-ink p-5 text-paper shadow-label md:rounded-[2.2rem] md:p-10">
          ...
          <p className="body-copy mt-5 max-w-2xl text-sm font-medium text-cream md:mt-6 md:text-base">
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <button
                  ...
                  className={`min-h-24 rounded-[1rem] border-2 p-3 text-left transition duration-300 hover:-translate-y-1 md:min-h-28 md:rounded-[1.2rem] md:p-4 ${
                    isActive
